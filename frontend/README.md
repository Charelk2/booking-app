...
When a category is selected, the artists listing page now filters the "Recommended for you" section to that category, preventing musicians from appearing when browsing DJs or other services.
