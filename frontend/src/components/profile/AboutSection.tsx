...
export default function AboutSection({ variant = 'mobile', displayName, profilePictureUrl, serviceProvider, highlights, onMessageClick }: Props) {
      ...
      <div className="min-w-0 flex-1">
        ...
        {formattedLocation && (
          <div className="mt-3 flex flex-wrap gap-2">
            <span className="inline-flex items-center rounded-full bg-gray-50 px-3 py-1 text-xs font-medium text-gray-700 ring-1 ring-inset ring-gray-200 dark:bg-gray-800/60 dark:text-gray-200 dark:ring-gray-700">
