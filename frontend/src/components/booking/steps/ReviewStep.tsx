...
export default function ReviewStep({
  ...
  return (
    <div className="wizard-step-container"> {/* THE ONE CARD FOR THIS STEP */}
      ...
      <p className="step-description">Please review your booking details before submitting your request.</p>

      {/* Review summary content - This is a section *within* the main step card */}
