...
>) {
  const base =
    ...
    // Subtle base ring; on hover match ring to bg so border visually disappears
    "ring-1 ring-black/10 dark:ring-white/10 hover:bg-[#D9FDD3] hover:ring-[#D9FDD3] " +
  ...
  if (linkOnly) {
    return (
      <GlassCard
        ...
        className="cursor-pointer outline-none ring-0 hover:ring-0 before:hidden after:hidden focus-visible:ring-2 focus-visible:ring-white/60 focus-visible:ring-offset-0"
        onClick={() =>
