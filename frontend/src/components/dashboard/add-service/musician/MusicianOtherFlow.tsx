...
export default function MusicianOtherFlow({
  isOpen,
  onClose,
  onServiceSaved,
  service,
}: MusicianOtherFlowProps) {
            ...
            >
              ...
              <div className="flex w-full flex-none flex-col justify-between overflow-y-auto bg-gray-50 p-6 md:w-1/5">
                <Stepper
                  ...
                  onStepClick={setStep}
                  ariaLabel="Add other service progress"
                  className="space-y-4"
                ...
                <div className="flex-1 space-y-4 overflow-y-scroll p-6">
                  {step === 0 && (
                    <div className="space-y-4">
                      ...
                      <TextInput
                        label="Tags (optional)"
                        value={state.typeFields.tags || ""}
                        onChange={(e) =>
                          actions.setTypeField("tags", e.target.value)
                        }
                        placeholder="e.g., wedding, corporate, session"
                      />
                    </div>
                  )}
