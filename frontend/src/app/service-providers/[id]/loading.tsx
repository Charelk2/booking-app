          ...
          <div className="relative bg-white/90 rounded-2xl shadow-sm border border-gray-100 p-4 backdrop-blur">
            ...
            <div className="mt-4 grid grid-cols-3 gap-2">
              {Array.from({ length: 3 }).map((_, i) => (
                <div
                  key={i}
                  className="h-8 bg-gray-100 border border-gray-200 rounded animate-pulse"
                />
              ))}
            </div>
          </div>
          ...
          <aside className="col-span-2 bg-white p-6">
            ...
            <div className="pt-0 bg-white">
              <div className="flex flex-col items-center text-center">
                <div className="relative -mt-12 h-24 w-24 rounded-full bg-gray-200 animate-pulse ring-4 ring-white" />
                ...
                <div className="mt-3 flex flex-wrap items-center justify-center gap-2">
                  {Array.from({ length: 6 }).map((_, i) => (
                    <div
                      key={i}
                      className="h-6 w-24 rounded-full bg-gray-100 border border-gray-200 animate-pulse"
                    />
                  ))}
                </div>
              </div>
